...
class TutorialsControllerTest < ActionController::TestCase
  ...
  test "should create tutorial" do
    assert_difference('Tutorial.count') do
      post :create, tutorial: { category: @tutorial.category, description: @tutorial.description, publish_date: @tutorial.publish_date, topic: @tutorial.topic, video_embed_code: @tutorial.video_embed_code }
    end
  ...
  test "should update tutorial" do
    patch :update, id: @tutorial, tutorial: { category: @tutorial.category, description: @tutorial.description, publish_date: @tutorial.publish_date, topic: @tutorial.topic, video_embed_code: @tutorial.video_embed_code }
    assert_redirected_to tutorial_path(assigns(:tutorial))
  end
